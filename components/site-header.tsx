...
export async function SiteHeader({ roomCode }: { roomCode: string }) {
  ...
  return (
    <header className="flex h-(--header-height) py-2 shrink-0 items-center gap-2 border-b border-border transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
