          ...
          <Accordion>
            <AccordionItem value="appearance">
              <AccordionTrigger>
                <div className="flex items-center gap-3">
                  <div className="border border-primary/10 bg-card">
                    <div className="flex items-center justify-center w-7 h-7 bg-primary/10">
                      <IconPalette className="w-4 h-4 text-primary" />
                    </div>
                  </div>
                  <span className="font-sans text-sm font-medium">Appearance</span>
                </div>
              </AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="privacy">
              <AccordionTrigger>
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-sans text-sm font-medium">Privacy & Security</span>
                </div>
              </AccordionTrigger>
              <AccordionContent>
                <div className="space-y-4 pb-2">
                ...
                <div className="space-y-3 pb-2">
                  <div className="flex items-center justify-between py-2 px-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-sans text-sm text-muted-foreground">Version</span>
                    </div>
                    <span className="font-mono text-sm">1.0.2</span>
                  </div>
                  <div className="flex items-center justify-between py-2 px-3">
                    <div className="flex items-center gap-2">
                      <IconCalendar className="w-4 h-4 text-muted-foreground/60" />
                      <span className="font-sans text-sm text-muted-foreground">Build</span>
                    </div>
                    <span className="font-mono text-sm">2025.01.03</span>
                  </div>
                  <div className="flex items-center justify-between py-2 px-3">
                    <div className="flex items-center gap-2">
                      <IconUser className="w-4 h-4 text-muted-foreground/60" />
                      <span className="font-sans text-sm text-muted-foreground">Creator</span>
                    </div>
                    <Link
                      href="https://github.com/NehanAhmed"
                      target="_blank"
                      className="font-mono text-sm hover:text-primary transition-colors duration-200 flex items-center gap-1"
                    >
                      Nehan Ahmed
